...
- [config] Add `--mode` flag and config variable. See [ADR-52](https://github.com/number571/tendermint/blob/master/docs/architecture/adr-052-tendermint-mode.md) @dongsam
...
- [blockchain/v1] [\#5701](https://github.com/number571/tendermint/pull/5701) Handle peers without blocks (@melekes)
