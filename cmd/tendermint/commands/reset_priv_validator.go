...
func init() {
	...
	ResetPrivValidatorCmd.Flags().StringVar(&keyType, "key", types.ABCIPubKeyTypeGost512,
		"Key type to generate privval file with. Options: '"+gost512.KeyType+"', '"+gost512.KeyType+"'")
}
