...
```sh
git clone https://github.com/number571/tendermint.git
cd tendermint
make install_abci
```
...
[here](https://github.com/number571/tendermint/blob/master/abci/cmd/abci-cli/abci-cli.go)
and looks like:
...
Golang](https://github.com/number571/tendermint/tree/master/abci/server). See the
...
example directory](https://github.com/number571/tendermint/tree/master/abci/example).
