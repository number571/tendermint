...
See our [light
package](https://pkg.go.dev/github.com/number571/tendermint/light?tab=doc).
...
A light client is initialized from a point of trust using [Trust Options](https://pkg.go.dev/github.com/number571/tendermint/light?tab=doc#TrustOptions),
