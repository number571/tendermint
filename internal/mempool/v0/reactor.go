...
import (
	...
	"github.com/number571/tendermint/internal/libs/clist"
	...
	protomem "github.com/number571/tendermint/proto/tendermint/mempool"
...
func (r *Reactor) broadcastTxRoutine(peerID types.NodeID, closer *tmsync.Closer) {
	...
	for {
		...
		// https://github.com/number571/tendermint/issues/5796
