...
import (
	...
	tmprivval "github.com/number571/tendermint/proto/tendermint/privval"
...
// https://github.com/number571/tendermint/issues/4698
...
// Due to g2015 expecting a 12 byte nonce we do not use the first four
